...
router.get('/email-preferences', authMiddleware, asyncHandler(AuthController.getEmailPreferences))
router.put('/email-preferences', authMiddleware, asyncHandler(AuthController.updateEmailPreferences))
